...
class TestComputations:
    ...
    def test_to_values_method_setup(self, mock_computations):
        ...
        patches = [
            ...
            patch.object(mock_computations, 'marginal_relief', return_value=None),
            patch.object(mock_computations, 'corporation_tax_chargeable_payable', return_value=10450),
            patch.object(mock_computations, 'net_corporation_tax_payable', return_value=10450),
